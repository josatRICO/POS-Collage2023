	...
	<style>
	    ...
	    <div class="bg-dark p-3 mb-3">
			<div class="row mx-0 py-3 bg-light d-flex">
				<div style="min-height:400px;" class="col-7 p-4">
				...
				<div class="col-5 bg-light p-4 pt-2">
					...
					<div class="table-responsive" style="height:400px;overflow-y: scroll;">
						...
						<div class="js-gtotal alert alert-danger my-2" style="font-size:30px">Total: ₱0.00</div>
						<div class="">
							<button onclick="show_modal('amount-paid')" class="btn btn-success my-2 w-100 py-3">Checkout</button>
							<button onclick="clear_all()" class="btn btn-primary w-100 py-3">Clear All</button>
						</div>
...
<script>
	...
	function product_html(data,index)
	{
		...
		return `
			<!--card-->
			<div class="card m-2 border-0 mx-auto" style="min-width: 130px;max-width: 100px;">
				<a href="#">
	...
	function validate_amount_paid(e)
	{
		...
		//open receipt page
		print_receipt({
			company:'Pares Ni Peso Atimonan',
			amount:amount,
			change:CHANGE,
			gtotal:GTOTAL,
			data:ITEMS
